            ...
            <FormField
              ...
              render={() => (
                <FormItem>
                  ...
                  <FormControl>
                    <FileUpload
                      parentId={process.env.NEXT_PUBLIC_PLUGIN_PARENT_ID}
                ...
                render={() => (
                  <FormItem>
                    ...
                    <FormControl>
                      <FileUpload
                        id="plugin-avatar"
                        parentId={process.env.NEXT_PUBLIC_IMAGE_PARENT_ID}
                        onUploadComplete={(data) => {
                ...
                render={() => (
                  <FormItem>
                    ...
                    <FormControl>
                      <FileUpload
                        id="plugin-cover"
                        parentId={process.env.NEXT_PUBLIC_IMAGE_PARENT_ID} // 修正为 process.env
                        onUploadComplete={(data) => {
